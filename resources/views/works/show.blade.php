...
<head>
    ...
    <style id="applicationStylesheet" type="text/css">
        .mediaViewInfo {
            --web-view-name: Web 1280 – 9;
            --web-view-id: Web_1280__9;
            --web-scale-on-resize: true;
            --web-enable-deep-linking: true;
        }

        :root {
            --web-view-ids: Web_1280__9;
        }
        ...
        * {
        ...
        #ASHIATO {
            ...
            --web-action-target: Web_1280___3.html;
            cursor: pointer;
            text-align: left;
        ...
        #n__webAPI____URL__httpsexample {
            left: 804px;
            top: 241px;
            position: absolute;
            overflow: visible;
        ...
        #User {
            ...
            --web-animation: fadein undefineds undefined;
            --web-action-type: page;
            --web-action-target: Web_1280___1.html;
            cursor: pointer;
        }
...
<body>
    <div id="Web_1280__9">
        <svg class="n_1244">
            <rect id="n_1244" rx="0" ry="0" x="0" y="0" width="1280" height="60">
            </rect>
        </svg>
        <div onclick="application.goToTargetView(event)" id="ASHIATO">
            <span>ASHIATO</span>
        </div>
        <div id="Java">
            <span>Javaアプリ</span>
        ...
        <svg class="Photo">
            <rect id="Photo" rx="0" ry="0" x="0" y="0" width="600" height="337.5">
            </rect>
        </svg>
        <div id="n__webAPI____URL__httpsexample">
            <span>担当箇所 : 〇〇機能、webAPI <br /><br />アプリURL : </span><span
                style="color:rgba(0,111,255,1);">https://example.com</span><br /><span>GitHub URL : </span><span
                style="color:rgba(0,111,255,1);">https://example.com</span>
        </div>
        <div id="Text">
            <span>アプリのタイトル</span>
        </div>
        <div id="n__JavaJavaScriptHTMLCSS">
            <span>使用言語 : Java、JavaScript、HTML/CSS</span>
        </div>
        <div id="Ruby">
            <span>Rubyアプリ</span>
        </div>
        <div id="JavaScript">
            <span>JavaScriptアプリ</span>
        </div>
        <div id="Pager">
            <div id="n_">
                <span>1</span>
            ...
            <div id="Component_-_Prev" class="Component___Prev">
                <svg class="n_1067">
                    <rect id="n_1067" rx="10" ry="10" x="0" y="0" width="50" height="50">
                    </rect>
                </svg>
                <div id="n_83">
                    <svg class="n_10" viewBox="0 0 16 16">
                        <path id="n_10"
                            d="M 8 0 L 6.545454978942871 1.454545497894287 L 12.05194854736328 6.961039066314697 L 0 6.961039066314697 L 0 9.038961410522461 L 12.05194854736328 9.038961410522461 L 6.545454978942871 14.54545497894287 L 8 16 L 16 8 L 8 0 Z">
                        </path>
                    </svg>
                </div>
            </div>
            <div id="Component_-_Next" class="Component___Next">
                <svg class="n_1066">
                    <rect id="n_1066" rx="10" ry="10" x="0" y="0" width="50" height="50">
                    </rect>
                </svg>
                <div id="n_82">
                    <svg class="n_10_cw" viewBox="0 0 16 16">
                        <path id="n_10_cw"
                            d="M 8 0 L 6.545454978942871 1.454545497894287 L 12.05194854736328 6.961039066314697 L 0 6.961039066314697 L 0 9.038961410522461 L 12.05194854736328 9.038961410522461 L 6.545454978942871 14.54545497894287 L 8 16 L 16 8 L 8 0 Z">
                        </path>
                    </svg>
        ...
        <div id="n__403">
            <span>ここにテキストが入ります。ここにテキストが入ります。ここにテキストが入ります。こ<br />ここにテキストが入ります。ここにテキストが入ります。ここにテキストが入ります。<br />ここにテキストが入ります。ここにテキストが入ります。ここにテキストが、40文字3行</span>
        </div>
        <div onclick="application.goToTargetView(event)" id="User">
            <svg class="n_32">
                <ellipse id="n_32" rx="23" ry="23" cx="23" cy="23">
                </ellipse>
            </svg>
            <div id="Icon_-_User" class="Icon___User">
                <svg class="n_1" viewBox="0 0 28 28">
                    <path id="n_1"
                        d="M 0 28 L 0 24.50045585632324 C 0 20.64960289001465 6.29992151260376 17.49960136413574 14 17.49960136413574 C 21.7000789642334 17.49960136413574 28 20.64960289001465 28 24.50045585632324 L 28 28 L 0 28 Z M 6.999212741851807 7.000797271728516 C 6.999212741851807 3.134220600128174 10.1334228515625 0 14 0 C 17.86500358581543 0 20.99921417236328 3.134220600128174 20.99921417236328 7.000797271728516 C 20.99921417236328 10.86577987670898 17.86500358581543 14.00005626678467 14 14.00005626678467 C 10.1334228515625 14.00005626678467 6.999212741851807 10.86577987670898 6.999212741851807 7.000797271728516 Z">
                    </path>
                </svg>
            </div>
        </div>
        <div id="Button_-_Press" class="Button___Press">
            <svg class="n_1090">
                <rect id="n_1090" rx="5" ry="5" x="0" y="0" width="80" height="36">
                </rect>
            </svg>
            <div id="Text_c">
                <span>編集</span>
        ...
        <div id="Button_-_Press_da" class="Button___Press">
            <svg class="n_1090_db">
                <rect id="n_1090_db" rx="5" ry="5" x="0" y="0" width="80" height="36">
                </rect>
            </svg>
            <div id="Text_dc">
                <span>削除</span>
        ...
        <div id="Component_-_Toggle_-_On" class="Component___Toggle___On">
            <svg class="n_788" viewBox="0 0 88 40">
                <path id="n_788"
                    d="M 20 0 L 68 0 C 79.04569244384766 0 88 8.954304695129395 88 20 C 88 31.04569625854492 79.04569244384766 40 68 40 L 20 40 C 8.954304695129395 40 0 31.04569625854492 0 20 C 0 8.954304695129395 8.954304695129395 0 20 0 Z">
                </path>
            </svg>
            <svg class="n_658">
                <rect id="n_658" rx="16" ry="16" x="0" y="0" width="32" height="32">
                </rect>
            </svg>
            <div id="Text_dg">
                <span>公開</span>
